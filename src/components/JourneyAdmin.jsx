                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-3 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                                            <p className="text-xs font-bold text-[#1A6B96] uppercase flex items-center gap-2">
                                                Journey Image <span className="text-[10px] bg-[#1A6B96] text-white px-2 py-0.5 rounded-full">Required</span>
                                            </p>
                                        ...
                                        <div className="space-y-3 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                                            <p className="text-xs font-bold text-[#1A6B96] uppercase flex items-center gap-2">
                                                Journey Video <span className="text-[10px] bg-slate-200 text-slate-500 px-2 py-0.5 rounded-full uppercase tracking-tighter">Optional</span>
                                            </p>
                                            ...
                                            {editingId && !formData.video && journeys.find(j => j._id === editingId)?.video && (
                                                <div className="h-32 rounded-xl bg-slate-100 border-2 border-slate-200 flex items-center justify-center p-2">
                                                    <p className="text-[10px] text-[#1A6B96] font-medium break-all text-center">
                                                        {journeys.find(j => j._id === editingId).video.split('/').pop()}
                                                    </p>
                                                </div>
                                            )}
                                            ...
                                            {!formData.video && (!editingId || (editingId && !journeys.find(j => j._id === editingId)?.video)) && (
